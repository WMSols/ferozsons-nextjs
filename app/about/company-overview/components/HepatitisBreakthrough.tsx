  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="container px-10">
        ...
        {/* Top Heading */}
        <h1 className="text-5xl md:text-6xl lg:text-[5rem] font-bold text-black mb-10 leading-[1.1]">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-12">
          ...
          <div className="flex flex-col text-black">
            ...
            <span className="text-2xl md:text-3xl leading-normal  mb-3">
              Patients Cured
            </span>
          ...
          {/* Right Image Card */}
          <div className="relative w-full md:w-[400px] aspect-[16/9] md:aspect-[4/3] rounded-[2rem] overflow-hidden shadow-lg shrink-0 group">
            {/* Placeholder Image */}
            <Image 
