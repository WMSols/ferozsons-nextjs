...
export default function SeventyYearsBanner() {
  return (
    <section className="py-12 md:py-16 bg-white">
      <div className="px-10 ">
        <div className="relative w-full rounded-[2rem] md:rounded-[3rem] overflow-hidden min-h-[500px] md:min-h-[800px] flex items-center shadow-lg group">
          ...
          <div className="relative z-10 px-6 py-12 md:px-16 lg:px-24 max-w-5xl flex flex-col">
            
            {/* Logo Row */}
            <div className="flex items-center ml-4 ">
              <div className="w-auto h-28  flex items-center justify-center">
                <img src="/ferozsons-f-white.webp" alt="Ferozsons white logo" className=" w-auto" />
              </div>
              <span className="text-white font-bold text-sm uppercase tracking-widest leading-tight">
                <img src="/people-trust-us.webp" alt="People Trust Us" className="h-52 w-auto" />
              </span>
            </div>

            <h2 className="text-white text-4xl md:text-5xl  font-bold leading-tight -mt-8 mb-16">
