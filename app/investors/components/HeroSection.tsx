          ...
          <div className="flex flex-col gap-6 md:gap-8 pb-20 md:pb-24 max-w-4xl">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <p className="text-white/80 text-sm font-light tracking-wide mt-1">
            ...
            <div className="flex items-center gap-4 md:gap-5">
              ...
              <div className="flex flex-col">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white/80 text-sm font-light hover:text-white transition-colors underline-offset-4 hover:underline mt-1"
                >
